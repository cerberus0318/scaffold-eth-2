export default class ShopScene extends Phaser.Scene {
  ...
  preload(): void {
    this.load.scenePlugin("AnimatedTiles", "./assets/AnimatedTiles.js", "animatedShop", "animatedShop");
  }
  ...
  create(data: any): void {
    ...
    // Animation
    this.animatedShop.init(this.map);
  ...
  update(): void {
    ...
    this.animatedShop.updateAnimatedTiles();
    if (isMobile) {
      this.moveCharacter(this.cursorKeys);
    } else {
